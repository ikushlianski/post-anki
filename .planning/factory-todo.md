# Implement-factory-work backlog

## Coding tasks

- [ ] Add a draggable, tool-calling AI chat panel docked bottom-right app-wide.
- [ ] Add AI Q&A with web search on curriculum topics, suggesting sub-topics.
