...
const INSTRUCTIONS = [
  ...
  "- A technology, framework, or subject name is NEVER a valid tag, no matter how the module is",
  "  phrased. 'React', 'Postgres', and 'Turbopuffer' are subjects, not tags — do not propose them.",
  "  'Performance' and 'security' ARE valid because they also apply to Java, JavaScript, Azure, and",
  "  every other unrelated technology, not just this one.",
  "- Strongly prefer reusing one of the existing tags listed under 'Existing cross-cutting tags in",
  "  use' below over inventing a new one. Propose a brand-new tag only when none of the existing",
  "  ones genuinely fit — err toward reuse rather than a slightly-more-precise new label.",
